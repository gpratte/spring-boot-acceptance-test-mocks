...
public class TodoStepDef2 extends SpringBootBaseIntegrationTest {
    ...
    public void exercise() {
        stubFor(get(urlEqualTo("/api/json/utc/now"))
            .willReturn(aResponse().withHeader("Content-Type", "application/json").withBody("{\"$id\":\"123\",\"currentDateTime\":\"2019-02-02T21:09Z\",\"utcOffset\":\"00:00:00\",\"isDayLightSavingsTime\":false,\"dayOfTheWeek\":\"Friday\",\"timeZoneName\":\"UTC\",\"currentFileTime\":131948249734579777,\"ordinalDate\":\"2019-47\",\"serviceResponse\":null}")));
        clockConnector.getCurrent();

        todo = Todo.builder()
            .description("exercise " + System.currentTimeMillis())
            .priority(2)
            .done(false)
            .build();
    }
